...
- **Правила** — «Chrome + YouTube → Медиа», «VS Code + timehub → задача #4» (время засчитывается, только если не идёт таймер, чтобы не считать дважды).
...
- recurring tasks and a weekly planner;
- a contribution graph of your activity.

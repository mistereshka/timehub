...
export interface HostApi {
  ...
  /** Pixel icons and your own pictures to choose from. */
  listMinecraftIcons(): import('./types').MinecraftIconChoice[]
  /** Chooses an icon by key; null goes back to the automatic one. */
  setMinecraftIcon(id: string, key: string | null): void
  shuffleMinecraftIcon(id: string): void
  openMinecraftIconFolder(): void
}
export const HOST_METHODS = [
  ...
  'renameMinecraft', 'pickMinecraftIcon', 'listMinecraftIcons', 'setMinecraftIcon', 'shuffleMinecraftIcon',
